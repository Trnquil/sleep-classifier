...
class HeartRateNightlyFeatureService(object):
    ...
    @staticmethod
    def build_feature_dict_from_cropped_normalized(subject_id, session_id, dataset):
        
        heart_rate_feature_raw = DataService.load_feature_raw(subject_id, session_id, FeatureType.normalized_hr, dataset)
    ...
    def build_feature_dict_from_epoched(subject_id, session_id, dataset, cluster_timestamps):
        ...
        heart_rate_feature = DataLoader.load_epoched(subject_id, session_id, FeatureType.epoched_hr , dataset)
