...
class HeartRateNightlyFeatureService(object):
    ...
    @staticmethod
    def build_feature_dict_from_cropped_normalized(subject_id, session_id, sleep_wake, dataset):
        
        heart_rate_feature_raw = DataService.load_feature_raw(subject_id, session_id, FeatureType.normalized_hr, sleep_wake, dataset)
    ...
    def build_feature_dict_from_epoched(subject_id, session_id, sleep_wake, dataset, cluster_timestamps):
        ...
        heart_rate_feature = DataLoader.load_epoched(subject_id, session_id, FeatureType.epoched_hr, sleep_wake, dataset)
