...
class FeatureType(Enum):
    ...
    nightly_cluster_wake_gmm = "wake GMM cluster"
    nightly_cluster_wake_kmeans = "wake KMeans cluster"
    nightly_cluster_sleep_gmm = "sleep GMM cluster"
    nightly_cluster_sleep_kmeans = "sleep KMeans cluster"
    nightly_cluster_sleep_GEMINI = "sleep GEMINI cluster"
    nightly_cluster_selfreported_sleep_gmm = "sleep GMM cluster"
    nightly_cluster_selfreported_sleep_kmeans = "sleep KMeans cluster"
    nightly_cluster_selfreported_sleep_GEMINI = "sleep GEMINI cluster"
    nightly_ibi = "IBI"
